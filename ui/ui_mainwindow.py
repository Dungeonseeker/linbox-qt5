...
class Ui_MainWindow(object):
    def setupui(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/resources/computer_white_36dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        MainWindow.setWindowIcon(icon)
        self.action_Run = QAction(MainWindow)
        self.action_Run.setObjectName(u"action_Run")
        icon1 = QIcon()
        icon1.addFile(u":/resources/play_arrow_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        self.action_Run.setIcon(icon1)
        self.action_Settings = QAction(MainWindow)
        self.action_Settings.setObjectName(u"action_Settings")
        icon2 = QIcon()
        icon2.addFile(u":/resources/settings_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        self.action_Settings.setIcon(icon2)
        self.action_Create = QAction(MainWindow)
        self.action_Create.setObjectName(u"action_Create")
        icon3 = QIcon()
        icon3.addFile(u":/resources/create_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        self.action_Create.setIcon(icon3)
        self.action_Quit = QAction(MainWindow)
        self.action_Quit.setObjectName(u"action_Quit")
        icon4 = QIcon()
        icon4.addFile(u":/resources/close_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        self.action_Quit.setIcon(icon4)
        self.action_Delete = QAction(MainWindow)
        self.action_Delete.setObjectName(u"action_Run")
        icon7 = QIcon()
        icon7.addFile(u":/resources/delete_forever_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        self.action_Delete.setIcon(icon7)
        self.action_About_Linbox = QAction(MainWindow)
        self.action_About_Linbox.setObjectName(u"actionAbout_Linbox")
        ...
        icon5 = QIcon()
        icon5.addFile(u":/resources/delete_forever_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/resources/folder_open_white_36dp.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.listWidget.setStyleSheet(u"color: rgb(255, 255, 255); selection-background-color: rgb(76, 76, 76);")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Linbox for 86Box - " + version, None))
